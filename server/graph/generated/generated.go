...
import (
	...
	"github.com/hyperxpizza/vuegqltodo/server/graph/custom"
...
func (ec *executionContext) field_Mutation_createContact_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewContact2githubᚗcomᚋhyperxpizzaᚋvuegqltodoᚋserverᚋgraphᚋmodelᚐNewContact(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateContact_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNUpdateContact2githubᚗcomᚋhyperxpizzaᚋvuegqltodoᚋserverᚋgraphᚋmodelᚐUpdateContact(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createContact(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNContact2ᚖgithubᚗcomᚋhyperxpizzaᚋvuegqltodoᚋserverᚋgraphᚋmodelᚐContact(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_updateContact(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateContact(rctx, args["input"].(model.UpdateContact))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) marshalNContact2githubᚗcomᚋhyperxpizzaᚋvuegqltodoᚋserverᚋgraphᚋmodelᚐContact(ctx context.Context, sel ast.SelectionSet, v model.Contact) graphql.Marshaler {
...
func (ec *executionContext) marshalNContact2ᚖgithubᚗcomᚋhyperxpizzaᚋvuegqltodoᚋserverᚋgraphᚋmodelᚐContact(ctx context.Context, sel ast.SelectionSet, v *model.Contact) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNNewContact2githubᚗcomᚋhyperxpizzaᚋvuegqltodoᚋserverᚋgraphᚋmodelᚐNewContact(ctx context.Context, v interface{}) (model.NewContact, error) {
...
func (ec *executionContext) unmarshalNUpdateContact2githubᚗcomᚋhyperxpizzaᚋvuegqltodoᚋserverᚋgraphᚋmodelᚐUpdateContact(ctx context.Context, v interface{}) (model.UpdateContact, error) {
